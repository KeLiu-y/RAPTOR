...
class MilitaryRSODDataset(CustomDataset):
    ...
    """
    CLASSES = ('Bridge', 'LMV', 'SMV', 'AFV', 'Overpass', 'Trainer_Aircraft',
               'Warship', 'FA-18', 'F-15', 'C-130', 'KC-135', 'Airport',
               'F-16', 'SU-35', 'TU-95', 'P-3C', 'Helicopter', 'SU-34',
               'B-52', 'Propeller_Aircraft', 'C-17', 'Dam', 'KC-10',
               'SU-24', 'MCV', 'B-1B', 'Dassault_Falcon-2000', 'F-22',
               'TU-22', 'E-3', 'C-5', 'Transport_Ship', 'E-8', 'TU-160',
               'Helipad', 'Aircraft_Carrier', 'Submarine')

    PALETTE = [
        (165, 42, 42), (189, 183, 107), (0, 255, 0), (255, 0, 0),
        (138, 43, 226), (255, 128, 0), (255, 0, 255), (0, 255, 255),
        (255, 193, 193), (0, 51, 153), (255, 250, 205), (0, 139, 139),
        (255, 255, 0), (147, 116, 116), (0, 0, 255), (230, 230, 250),
        (0, 100, 0), (170, 110, 40), (128, 0, 0), (128, 128, 0),
        (0, 128, 128), (128, 0, 128), (255, 215, 0), (192, 192, 192),
        (70, 130, 180), (210, 105, 30), (255, 20, 147), (0, 191, 255),
        (34, 139, 34), (255, 105, 180), (255, 140, 0), (154, 205, 50),
        (139, 69, 19), (100, 149, 237), (220, 20, 60), (75, 0, 130),
        (240, 230, 140)
    ]
    ...
    def __init__(self,
        ...
        super(MilitaryRSODDataset, self).__init__(ann_file, pipeline, **kwargs)
                ...
                with open(ann_file) as f:
                    ...
                    for si in s:
                        ...
                        if cls_name not in cls_map:
                            warnings.warn(f'Class {cls_name} in {ann_file} is not in CLASSES.')
                            continue
